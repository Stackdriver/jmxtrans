...
public class StackdriverWriter extends BaseOutputWriter {
	...
	public void validateSetup(Query query) throws ValidationException {
		...
		if (apiKey == null || ORIGINAL_STACKDRIVER_API_KEY.equals(apiKey)) {
			...
			String newApiKey = getMetadataValue("GCE", "http://metadata/computeMetadata/v1/project/attributes/stackdriver-agent-key", headers);
			if (newApiKey != null) {
